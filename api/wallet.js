...
module.exports = async (req, res) => {
  ...
  try {
    ...
    const pass = await PKPass.from({
      ...
      certificates: {
        wwdr: path.join(process.cwd(), "api", "wwdr.pem"),
        signerCert: path.join(process.cwd(), "api", "pass.pem"),
        signerKey: path.join(process.cwd(), "api", "pass.key"),
